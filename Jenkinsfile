pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'AZAHAR_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-azahar'
    CONTAINER_NAME = 'azahar'
    DOCKERHUB_IMAGE = 'linuxserver/azahar'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/azahar'
    PR_DOCKERHUB_IMAGE = 'lspipepr/azahar'
    DIST_IMAGE = 'arch'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-azahar/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-azahar\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-azahar\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Azahar\" \
          --label \"org.opencontainers.image.description=[Azahar](https://azahar-emu.org/) is an open-source 3DS emulator based on Citra.\" \
